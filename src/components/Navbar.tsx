        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-4 sm:space-x-8">
            <Link to="/dashboard" className="flex items-center space-x-2">
              ...
              <span className="text-lg sm:text-xl font-bold text-foreground hidden xs:block">Community Chat</span>
              <span className="text-lg font-bold text-foreground xs:hidden">Chat</span>
            </Link>
